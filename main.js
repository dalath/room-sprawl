...
//--------------------
//
function init() { // Called from index.html
    //
    setupStyle();
    setupRooms();
    //
...
//
function setupRooms() { // This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
    //
...
//
function refreshNavButtons() { // Updates the UI navigation button states
    //
    var x = currentRoom.x;
    var y = currentRoom.y;
    //
