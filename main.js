...
{// This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
	...
	addRoom(1,4, "Forgotten Alter", "A dusty alter sits tucked against the west wall in an otherwise empty chamber. 4 candles sit upon it's surface, 3 of them lit. The light flickers across rosary cast to the floor nearby.", null, "rosary");
