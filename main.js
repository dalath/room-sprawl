...
{// This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
	...
	addRoom(8,3, "Anti Gravity Room", "As soonas you enter you realise you are starting to float towards the ceiling, which is covered in gold and opens a portal to somewhere.",null,null);
}
//
