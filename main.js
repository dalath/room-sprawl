...
{// This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
	...
	addRoom(2,3, "Ruins", "The now spotless dusty walls also reveals a passage. As you follow the path, you notice your descent downwards, and eventually the tunnel opens into a large, ruined, underground civilization. Perhaps you can find some lost treasure down here.", "shiny cup", "door handle");
