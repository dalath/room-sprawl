...
{// This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
	...
	addRoom(2,5, "Boarded Up Room", "After smashing your way through with the Hammer, you find what looks like a storage room. There's nothing in here aside from some ancient looking broomsticks in the corner and cobwebs.");
